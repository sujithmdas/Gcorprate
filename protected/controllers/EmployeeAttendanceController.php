...
class EmployeeAttendanceController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['EmployeeAttendance']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash('success', "Leave Marked Successfully!");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['EmployeeAttendance']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash('success', "Leave Details Updated Successfully!");
                            $this->redirect(array('admin'));
                        }
		}
	...
	public function actionDelete($id)
	{
		try{
                    ...
                    if(!isset($_GET['ajax']))
                        Yii::app()->user->setFlash('success','Leave Deleted Successfully!');
                    else
                        echo "<div class='flash-success'>Leave Deleted Successfully!</div>";
                }catch(CDbException $e){
                    if(!isset($_GET['ajax']))
                        Yii::app()->user->setFlash('error','Failed to Delete Leave!');
                    else
                        echo "<div class='flash-error'>Failed to Delete Leave!</div>"; //for ajax
                }
