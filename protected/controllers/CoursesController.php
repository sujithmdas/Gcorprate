...
class CoursesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Courses']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash('success', "Course Created Successfully!");
	...
	public function actionDelete($id)
	{
		try{
                    ...
                    if(!isset($_GET['ajax']))
                        Yii::app()->user->setFlash('success','Course Deleted Successfully!');
                    else
                        echo "<div class='flash-success'>Course Deleted Successfully!</div>";
                }catch(CDbException $e){
                    if(!isset($_GET['ajax']))
                        Yii::app()->user->setFlash('error','Failed to Delete Course!');
                    else
                        echo "<div class='flash-error'>Failed to Delete Course!</div>"; //for ajax
                }
