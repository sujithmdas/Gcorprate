...
class EmployeesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Employees']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash('success', "Employee Created Successfully!");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Employees']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash('success', "Employee Details Updated Successfully!");
                            $this->redirect(array('admin'));
                        }
		}
	...
	public function actionDelete($id)
	{
		try{
                    ...
                    if(!isset($_GET['ajax']))
                        ...
                        echo "<div class='flash-success'>Employee Deleted Successfully!</div>";
                }catch(CDbException $e){
                    if(!isset($_GET['ajax']))
                        Yii::app()->user->setFlash('error','Failed to Delete Employee!');
                    else
                        echo "<div class='flash-error'>Failed to Delete Employee!</div>"; //for ajax
                }
