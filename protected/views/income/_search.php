...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'income_title'); ?>
		<?php echo $form->textField($model,'income_title',array('size'=>60,'maxlength'=>60)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'finance_category_id'); ?>
