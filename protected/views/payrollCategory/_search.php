...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'percentage_of'); ?>
		<?php echo $form->textField($model,'percentage_of'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'is_deduction'); ?>
		<?php echo $form->textField($model,'is_deduction',array('size'=>1,'maxlength'=>1)); ?>
	</div>
