...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'fees_collection_name'); ?>
		<?php echo $form->textField($model,'fees_collection_name',array('size'=>45,'maxlength'=>45)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'fees_category_id'); ?>
		<?php echo $form->textField($model,'fees_category_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'fine_id'); ?>
