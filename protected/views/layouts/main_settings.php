...
<!--<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('img','','images/logoutup.jpg',1)"><img src="images/logout.png" alt="Logout" name="img" width="20" height="20" border="0" id="img" title="Logout"/></a>-->
</div>
</div>
