...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'subject_name',array('size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'subject_name'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'subject_code'); ?>
		<?php echo $form->textField($model,'subject_code',array('size'=>45,'maxlength'=>45)); ?>
