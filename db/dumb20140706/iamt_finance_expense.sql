...
CREATE TABLE `expense` (
  ...
  CONSTRAINT `fk_expense_1` FOREIGN KEY (`finance_category_id`) REFERENCES `finance_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `expense` VALUES (1,'expense1','desc1',100000.00,'0000-00-00',2);
