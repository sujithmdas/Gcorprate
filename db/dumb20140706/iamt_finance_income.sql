...
CREATE TABLE `income` (
  ...
  CONSTRAINT `fk_income_1` FOREIGN KEY (`finance_category_id`) REFERENCES `finance_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `income` VALUES (1,'income1','desc1',1000.00,'2014-07-04',1);
