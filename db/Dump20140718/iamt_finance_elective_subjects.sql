...
CREATE TABLE `elective_subjects` (
  ...
  CONSTRAINT `elective_group_id` FOREIGN KEY (`group_id`) REFERENCES `elective_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `elective_subjects`
--

LOCK TABLES `elective_subjects` WRITE;
/*!40000 ALTER TABLE `elective_subjects` DISABLE KEYS */;
/*!40000 ALTER TABLE `elective_subjects` ENABLE KEYS */;
UNLOCK TABLES;
