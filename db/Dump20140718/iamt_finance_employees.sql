...
CREATE TABLE `employees` (
  ...
  CONSTRAINT `fk_employees_1` FOREIGN KEY (`category_id`) REFERENCES `employee_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `employees` VALUES (1,'employee1','emp001','2014-07-06','1998-07-06','M',1,1,'Administrator','qual','exp','email','addr',321456,'9876543120','1234657890','','','A'),(2,'Employee2','emp002','2014-07-06','1998-07-06','F',1,1,'Administrator','qual','exp','email','addr',987456,'3216549877','321654988','','21654897147852','I');
