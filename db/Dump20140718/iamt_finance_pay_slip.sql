...
--
-- Host: 127.0.0.1    Database: iamt_finance
-- ------------------------------------------------------
...
CREATE TABLE `pay_slip` (
  ...
  CONSTRAINT `pay_slip_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`)
...
INSERT INTO `pay_slip` VALUES (1,1,'2014-07-01',5000.00,150.00);
...
-- Dump completed on 2014-07-18 11:54:51
